...
function GetBlogs() {
  $.ajax({
    url: "https://api.rss2json.com/v1/api.json?rss_url=https://blogs.shahriyarali.com/feed.rss",
    method: "GET",
    success: GotBlogs,
    error: function () {
